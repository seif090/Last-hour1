...
export default function SearchClient({ initialQuery, initialResults }: { initialQuery: string; initialResults: Offer[] }) {
  const [query, setQuery] = useState(initialQuery);
  const [results, setResults] = useState<Offer[]>(initialResults);
