...
export default function AdminMerchantsPage() {
  ...
  return (
    <div>
      ...
      {merchants.length === 0 ? (
        <div className="text-center py-12"><Store className="h-12 w-12 text-gray-300 mx-auto mb-3" /><p className="text-gray-500">No merchants found</p></div>
      ) : (
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{merchant.user?.email} · {merchant.businessType}</p>
                  </div>
