                ...
                child: Column(
                  ...
                  children: [
                    GridView.count(
                      ...
                      children: [
                        _card('Users', '${_stats?['users'] ?? 0}', Icons.people, Colors.blue),
                        _card('Merchants', '${_stats?['merchants'] ?? 0}', Icons.store, Colors.orange),
                        _card('Orders', '${_stats?['orders'] ?? 0}', Icons.receipt_long, Colors.green),
                        _card('Revenue', '${_stats?['revenue'] ?? 0}', Icons.currency_pound, Colors.purple),
